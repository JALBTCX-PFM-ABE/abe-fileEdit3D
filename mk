...
if [ $SYS = "Linux" ]; then
    DEFS=NVLinux
    LIBRARIES="-L $PFM_LIB -lpfm -lCZMIL -lCHARTS -lgsf -llas -lnvutility -lgdal -lxml2 -lpoppler -lproj -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X"
    LIBRARIES="-L $PFM_LIB -lpfm -lCZMIL -lCHARTS -lgsf -llas -lnvutility -lgdal -lxml2 -lpoppler -lproj -lglu32 -lopengl32 -liconv -lwsock32"
