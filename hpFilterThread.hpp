...
public:
  ...
  void filter (OPTIONS *op = NULL, MISC *mi = NULL, POINT_DATA *pntd = NULL, BIN_DATA **bd = NULL, POS_DATA *pd = NULL, int32_t rws = 0, int32_t cls = 0,
...
protected:
  ...
  int32_t          l_rows, l_cols, l_width, l_height, l_row, l_col, *l_kill_count;
